...
<header class="antialiased fixed ">
    <nav class="bg-white border-gray-200 z-40 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
...
<aside id="default-sidebar z-10" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
