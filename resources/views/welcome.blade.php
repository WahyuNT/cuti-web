...
<body class="bg-[#f9fafb]">
    <header class="antialiased fixed  w-full">
        <nav class="bg-white border-gray-600 border-bottom-2 shadow-sm px-4 lg:px-6 py-2.5">
    ...
    <aside id="default-sidebar"
        class="fixed bg-white z-10 top-0 left-0 shadow-md border-r-1 border-gray-200 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar">
