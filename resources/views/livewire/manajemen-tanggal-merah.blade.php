<div class="bg-white rounded-xl p-4">
    @if ($mode == 'view')
        ...
        <div class="w-full">
            <h2 class="text-3xl font-bold text-center">Manajemen Tanggal Merah</h2>
        </div>
        <div class="w-full">
            <div class="w-full flex items-end gap-2 mt-4">
                <div class="flex-1">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.live="filter" type="text" placeholder="Masukkan Keterangan Tanggal Merah"
                ...
                <div>
                    <x-button wire:click="toggleMode" label="Tambah Tanggal Merah" class="whitespace-nowrap" />
                </div>
            </div>
    ...
    @elseif($mode == 'edit')
        ...
        <div class="w-full mt-4">
            <div class="grid grid-cols-2 gap-4">
                <x-input label="Tanggal" for="tanggal" wire="tanggal" type="date" placeholder="Tanggal"
                    :required="true" />
                <x-input label="Keterangan" for="keterangan" wire="keterangan" type="text" placeholder="Deskripsi"
                    :required="true" />
                ...
                <div class="col-span-2 flex justify-center items-end gap-2">
                    ...
                    @else
                        <x-button wire:click="create" bg="[var(--success)]" label="Simpan Izin" />
                    @endif
