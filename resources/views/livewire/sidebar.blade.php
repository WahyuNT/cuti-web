            ...
            <ul class="space-y-2 font-medium mt-6">
                ...
                <li>
                    <a href="{{ route('pengajuan-cuti') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group {{ request()->routeIs('pengajuan-cuti') ? 'bg-gray-100' : '' }}">
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 {{ request()->routeIs('pengajuan-cuti') ? 'text-gray-900' : 'group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 18">
                            <path
                ...
                <li>
                    <a href="{{ route('pengajuan-izin') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 {{ request()->routeIs('pengajuan-izin') ? 'text-gray-900' : 'group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path
                                d="m17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377ZM6 12H4a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2Z" />
                        </svg>
                        <span class="flex-1 ms-3 whitespace-nowrap">Pengajuan Izin</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('riwayat-cuti') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group {{ request()->routeIs('riwayat-cuti') ? 'bg-gray-100' : '' }}">
                ...
                <li>
                    <a href="{{ route('permohonan-cuti') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group {{ request()->routeIs('permohonan-cuti') ? 'bg-gray-100' : '' }}">
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 {{ request()->routeIs('permohonan-cuti') ? 'text-gray-900' : 'group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
                            <path
                        ...
                        @if ($cutiCount > 0)
                            <span
                                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">{{ $cutiCount }}</span>
                        @endif
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('permohonan-izin') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 {{ request()->routeIs('permohonan-izin') ? 'text-gray-900' : 'group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 20">
                            <path
                                d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z" />
                        </svg>
                        <span class="flex-1 ms-3 whitespace-nowrap">Permohonan Izin</span>
                        @if ($izinCount > 0)
                            <span
                                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">{{ $izinCount }}</span>
                        @endif
                    </a>
                </li>
                <li class="px-2 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                ...
                <li>
                    <a href="{{ route('manajemen-web') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 {{ request()->routeIs('manajemen-web') ? 'text-gray-900' : 'group-hover:text-gray-900' }}"
                ...
                <li>
                    <a href="{{ route('manajemen-user') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 {{ request()->routeIs('manajemen-user') ? 'text-gray-900' : 'group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
