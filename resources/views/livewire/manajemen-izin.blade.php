<div class="bg-white rounded-xl p-4">
    @if ($mode == 'view')
        ...
        <div class="w-full">
            <h2 class="text-3xl font-bold text-center">Manajemen Tipe Izin</h2>
        </div>
        <div class="w-full">
            <div class="w-full flex items-end gap-2 mt-4">
                ...
                <div>
                    <x-button wire:click="toggleMode" label="Tambah Izin" class="whitespace-nowrap" />
                </div>
            </div>
    ...
    @elseif($mode == 'edit')
        ...
        <div class="w-full mt-4">
            <div class="grid grid-cols-2 gap-4">
                <x-input label="Nama" for="name" wire="name" type="text" placeholder="Nama Izin"
                    :required="true" />
